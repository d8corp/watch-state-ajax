# @watch-state/ajax
[![NPM](https://img.shields.io/npm/v/@watch-state/ajax.svg)](https://github.com/d8corp/watch-state-ajax/blob/master/CHANGELOG.md)
[![downloads](https://img.shields.io/npm/dm/@watch-state/ajax.svg)](https://www.npmjs.com/package/watch-state-ajax)
[![license](https://img.shields.io/npm/l/@watch-state/ajax)](https://github.com/d8corp/watch-state-ajax/blob/master/LICENSE)  
Ajax functionality for [watch-state](https://www.npmjs.com/package/watch-state).  
